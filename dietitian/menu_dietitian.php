...
<main class="container text-center py-5">
  <?php if ($type === 'nutrition'): ?>
    <div class="position-relative text-center mb-4">
      <a href="dashboard_dietitian.php?patient_id=<?= urlencode($patientId) ?>" class="btn btn-outline-secondary btn-sm position-absolute top-0 start-0 mt-1 ms-2">🔙 חזרה</a>    
      <h2 class="mb-0">🍽️ תזונה יומית</h2>
    </div>
    <div class="d-grid gap-3 col-md-6 mx-auto">
      <a href="meal_log_dietitian.php" class="btn btn-lg text-white" style="background-color: #f4b6bd;">📚 צפייה ומתן הערות על יומן ארוחות</a>
      <a href="edit_personal_menu.php" class="btn btn-lg text-white" style="background-color: #f4b6bd;">📝 עריכת תפריט אישי</a>
    </div>
  ...
  <?php elseif ($type === 'glucose'): ?>
    ...
    <div class="d-grid gap-3 col-md-6 mx-auto">
      <a href="glucose_history_dietitian.php" class="btn btn-lg text-white" style="background-color: #f4b6bd;">📊 צפייה ומתן הערות על מדידות סוכר</a>
    </div>
  <?php endif; ?>
</main>
